...
- Lembre que importar `core/database.ts` abre `./data/sqlite3.db` e executa `database.migrate()`. Prefira `npx tsc --noEmit` e testes isolados durante validações; não use o banco real como fixture.
